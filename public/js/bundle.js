    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe'; // const formDataObject = Object.fromEntries(data.entries());
...
exports.handleEditModal = exports.UserUpdate = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var UserUpdate = exports.UserUpdate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, body) {
    var _iterator, _step, entry, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 6:
          res = _context.sent;
          if (res.data.status === 'success') (0, _alerts.showAlert)('success', "User updated successfully ".concat(body));
          _context.next = 13;
          break;
        case 10:
          _context.prev = 10;
...
var handleEditModal = exports.handleEditModal = function handleEditModal(modalContainer, id, e) {
  var submitButton = document.querySelector('#submit');
  var dropdown = document.querySelector('#role');
  var selectedOptionValue;
  dropdown.addEventListener('change', function (event) {
    selectedOptionValue = event.target.value;
    console.log("User picked: ".concat(selectedOptionValue));
  });
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            form = new FormData();
            if (document.getElementById('name').value) form.append('name', document.getElementById('name').value);
            if (document.getElementById('email').value) form.append('email', document.getElementById('email').value);
            if (document.getElementById('password').value) form.append('password', document.getElementById('password').value);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","../../utils/catchAsync":"../../utils/catchAsync.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var adminCardPage = document.querySelectorAll('.card.cardAdmin');
// DELEGATION
if (mapBox) {
...
if (userDataForm) {
  userDataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var form, _iterator, _step, entry;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
...
if (adminCardPage) {
  ...
  var formUserPhoto = document.querySelector('.form__user-photo');
  adminCard.forEach(function (card) {
    ...
    updateButton.addEventListener('click', function (e) {
      ...
      formUserPhoto.src = "/img/users/".concat(userJson.photo);
      (0, _admin.handleEditModal)(modalContainer, userJson._id, e.target);
    });
  });
